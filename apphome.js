  ...
  return {
    ...
    text: {
      ...
      text: `You currently have ${
        walletsForUser.length
      } wallets with a total of ${sumPoints(walletsForUser)} points`,
    },
  };
};
